...
| --- | --- | --- | --- |
| GAP-019 | BSP Batterie (§Règles BSP) | `bsp_battery_read_mv()` renvoie une valeur fictive liée à la luminosité et n'exploite aucun capteur réel. | Implémenter la lecture ADC calibrée du diviseur batterie avec filtrage et options Kconfig. |
