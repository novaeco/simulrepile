...
* Utiliser ESP-IDF ≥ 6.1, LVGL 9.4, LovyanGFX. Les fichiers ici ne sont que des squelettes : conserver les stubs si les implémentations complètes ne sont pas encore disponibles.
